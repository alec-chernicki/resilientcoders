export default [
  ...
  {
    title: 'Rstudio',
    note: 'The magic of mentorship',
    image: 'https://resilientcoders.s3.amazonaws.com/i/hire/rstudio_logo_min.jpg',
    description: "It is through our work with RStudio that we realized the true extent of the value of mentorship. In collaboration with Resilient Coders, RStudio developed an onboarding plan spelling out the expectations for the hire and reserving time for continued learning. This went a long way in making sure that all of us stood behind Karen's continued success on the job. Not surprisingly, at the end of a four-month contract, Karen was hired full-time.",
  },
  {
    title: 'DigitasLBI',
